...
import { fetchSupportedFormats, uploadReport } from '../api/client';
...
export default function UploadScreen({ navigation }) {
  ...
  async function handleUpload(file) {
    ...
    try {
      ...
      Alert.alert('Uploaded', 'Your report is processing. Check the Timeline tab for its status.', [
        { text: 'Go to Timeline', onPress: () => navigation.navigate('TimelineTab') },
