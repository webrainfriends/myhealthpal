// Supported languages for both AI-generated explanatory text - insight
...
// (medicationKnowledgeService.js) - and, client-side, the mobile app's own
// UI chrome and voice/TTS reading language (see mobile/src/i18n/ and
// mobile/src/voice/VoiceContext.jsx, which mirror this same list). Kept as
// a fixed allow-list (like medicationKnowledgeBase.js's curated entries)
// rather than accepting any string, so a typo or unsupported code always
// falls back to English instead of silently asking a model to write in a
// language it was never actually asked to write in.
